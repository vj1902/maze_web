...
cc.Class({
    ...
    properties: {
        Fish:cc.Node,
        Canvas:cc.Node,
        // myMusic:cc.AudioClip,
        // myEffect:cc.AudioClip,
    },
    onLoad() {
        var self = this;
        var Xorigin;
        ...
        this.Canvas.on('touchstart',function(touch){
            ...
            XforCheck = Xorigin;
            IsWorkable = true;
            cc.audioEngine.play(this.myMusic,false,0.4);
    ...
    onCollisionEnter: function(other,self) {
        ...
        if(other.tag == 1)
        {
            cc.audioEngine.playEffect(this.myEffect,false,0.4);
            cc.director.loadScene("front2");
        }
    },
    start () {
