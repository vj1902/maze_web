...
cc.Class({
    ...
    GoNorth() {
        ...
        // var a=this.SetPositionInGrid(this.GridLocX)
        // var b= this.SetPositionInGrid(this.GridLocY-1)
        // // var pos =SetPositionInGrid(this.GridLocX,this.GridLocY-1);
        // var build=cc.instantiate(this.path);
        // this.node.addChild(build);
    ...
    GoWest() {
        ...
        this.LatestDir = "West";
        this.AutoMove();
     //   console.log(this.SetPositionInGrid())
    ...
    AutoMove() {
       ...
       // this.node.getChildByName('locked').setPosition(this.node.getChildByName('locked').position.x+=10,this.node.getChildByName('locked').position.y);
    ...
    SetPositionInGrid(x,y) {
        ...
        // var build=cc.instantiate(this.path);
        // this.node.addChild(build);
        // build.setPosition(this.GridLocX,this.GridLocY);
